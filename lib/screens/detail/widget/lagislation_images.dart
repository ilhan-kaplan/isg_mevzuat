       ...
       children: [
         Padding(
           ...
           child: Column(
             crossAxisAlignment: CrossAxisAlignment.start,
             children: [
               Text('Mevzuat İçeriği',
                 style:TextStyle(fontSize: 20, fontWeight: FontWeight.bold,color: cFont) ,
               ),
               SizedBox(height: 10,),
               Text('Mevzuat içerisinde kelime arayarak ilgili maddeye kolayca ulaşabilirsiniz...',
                 style:TextStyle(fontSize: 12, fontWeight: FontWeight.bold,color: cFontLight)),
             ],
           ),
         ),
         SizedBox(height: 10,),
...
class legislation_extract extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (context) => SearchingPage(chosing)),);
      },
      child: Stack(
          children: [
            Container(
            ...
            Positioned(
              ...
              left: 1,
                child:
                    SizedBox(height:120,child: Image.asset(resim)),
                ),
            Positioned(
              top:10,
              left: 10,
              child: SizedBox(
                width: 150,
                child: Text(baslik,
                  style: TextStyle(color:cFont,fontSize: 18,fontWeight: FontWeight.bold),
                ),
              ),
            ),
          ],
